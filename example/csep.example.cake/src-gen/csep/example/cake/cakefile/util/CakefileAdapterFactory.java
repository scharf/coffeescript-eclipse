...
public class CakefileAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected CakefileSwitch<Adapter> modelSwitch =
    new CakefileSwitch<Adapter>()
    {
      @Override
      public Adapter caseCakefile(Cakefile object)
      {
        return createCakefileAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link csep.example.cake.cakefile.Cakefile <em>Cakefile</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link csep.example.cake.cakefile.TaskDeclaration <em>Task Declaration</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
