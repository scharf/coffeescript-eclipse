...
:
(
{ before(grammarAccess.getRootAccess().getBodyParserRuleCall_0()); }
	ruleBody
{ after(grammarAccess.getRootAccess().getBodyParserRuleCall_0()); }
)
...
:
(
{ before(grammarAccess.getRootAccess().getBlockParserRuleCall_1_0()); }
	ruleBlock
{ after(grammarAccess.getRootAccess().getBlockParserRuleCall_1_0()); }
)
...
:
(
{ before(grammarAccess.getRootAccess().getTERMINATORTerminalRuleCall_1_1()); }
	RULE_TERMINATOR
{ after(grammarAccess.getRootAccess().getTERMINATORTerminalRuleCall_1_1()); }
)
